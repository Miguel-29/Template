...
!function (t, e) {
  ...
  var G = {
    ...
    return r.toggle = function () {
      ...
      var i = T(t, "bs.collapse"),
          r = n({}, G, z.getDataAttributes(t), "object" == _typeof(e) && e ? e : {});
  ...
  var oe = ie(),
    ...
    return r.toggle = function () {
      ...
      if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
        ...
        if (!B.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
          if (this._inNavbar) z.setDataAttribute(this._menu, "popper", "none");else {
            ...
            var n = this._element;
            "parent" === this._config.reference ? n = t : d(this._config.reference) ? (n = this._config.reference, void 0 !== this._config.reference.jquery && (n = this._config.reference[0])) : "object" == _typeof(this._config.reference) && (n = this._config.reference);
      ...
      if (t = n({}, this.constructor.Default, z.getDataAttributes(this._element), t), p("dropdown", t, this.constructor.DefaultType), "object" == _typeof(t.reference) && !d(t.reference) && "function" != typeof t.reference.getBoundingClientRect) throw new TypeError("dropdown".toUpperCase() + ': Option "reference" provided type "object" without a required "getBoundingClientRect" method.');
      return t;
    ...
    return r.toggle = function (t) {
      ...
      return this.each(function () {
        var i = T(this, "bs.modal"),
            r = n({}, _e, z.getDataAttributes(this), "object" == _typeof(t) && t ? t : {});
  ...
  var Ae = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
    ...
    return r.enable = function () {
      ...
      if (null !== t) return "object" == _typeof(e) && d(e) ? (e.jquery && (e = e[0]), void (this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = ke(e, this.config.allowList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e);
    }, r.getTitle = function () {
  ...
  var Be = {
    ...
    return r.refresh = function () {
      ...
      if ("string" != typeof (t = n({}, Be, "object" == _typeof(t) && t ? t : {})).target && d(t.target)) {
        var e = t.target.id;
  ...
  var Ke = {
    ...
    return r.show = function () {
      ...
      return t = n({}, Ue, z.getDataAttributes(this._element), "object" == _typeof(t) && t ? t : {}), p("toast", t, this.constructor.DefaultType), t;
    }, r._setListeners = function () {
      var t = this;
